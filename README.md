...
<text class="ts" x="40" y="30" style="font-weight:500;fill:var(--color-text-secondary)">Data sources</text>

<!-- Product Hunt -->
<g class="node c-coral" onclick="sendPrompt('How does Pookies fetch from Product Hunt?')">
  <rect x="40" y="44" width="130" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="105" y="62" text-anchor="middle" dominant-baseline="central">Product Hunt</text>
  <text class="ts" x="105" y="78" text-anchor="middle" dominant-baseline="central">New launches</text>
</g>
<!-- HuggingFace -->
<g class="node c-coral" onclick="sendPrompt('What does Pookies scrape from HuggingFace?')">
  <rect x="186" y="44" width="130" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="251" y="62" text-anchor="middle" dominant-baseline="central">HuggingFace</text>
  <text class="ts" x="251" y="78" text-anchor="middle" dominant-baseline="central">AI models</text>
</g>
<!-- GitHub -->
<g class="node c-coral" onclick="sendPrompt('What GitHub data does Pookies use?')">
  <rect x="332" y="44" width="130" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="397" y="62" text-anchor="middle" dominant-baseline="central">GitHub</text>
  <text class="ts" x="397" y="78" text-anchor="middle" dominant-baseline="central">Trending projects</text>
</g>
<!-- Reddit -->
<g class="node c-coral" onclick="sendPrompt('What Reddit data does Pookies use?')">
  <rect x="478" y="44" width="130" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="543" y="62" text-anchor="middle" dominant-baseline="central">Reddit</text>
  <text class="ts" x="543" y="78" text-anchor="middle" dominant-baseline="central">Community picks</text>
</g>

<!-- Arrows down to Automation -->
<line x1="105" y1="88" x2="105" y2="144" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>
<line x1="251" y1="88" x2="251" y2="144" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>
<line x1="397" y1="88" x2="340" y2="144" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>
<line x1="543" y1="88" x2="340" y2="144" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>
<line x1="105" y1="144" x2="304" y2="144" stroke="var(--color-border-secondary)" stroke-width="1" fill="none"/>

<!-- ====== Automation Block ====== -->
<text class="ts" x="40" y="170" style="font-weight:500;fill:var(--color-text-secondary)">Automation (GitHub Actions · 6 AM UTC daily)</text>

<g class="node c-amber" onclick="sendPrompt('How does the GitHub Actions automation work in Pookies?')">
  <rect x="200" y="184" width="280" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="340" y="206" text-anchor="middle" dominant-baseline="central">Python scripts (auto_update/)</text>
  <text class="ts" x="340" y="224" text-anchor="middle" dominant-baseline="central">Extract name, pricing, features, platforms, logo</text>
</g>

<!-- Arrow down to Data -->
<line x1="340" y1="240" x2="340" y2="278" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>

<!-- ====== Data Layer ====== -->
<text class="ts" x="40" y="298" style="font-weight:500;fill:var(--color-text-secondary)">Data layer</text>

<g class="node c-teal" onclick="sendPrompt('What is in the tools-data.json file?')">
  <rect x="200" y="310" width="280" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="340" y="328" text-anchor="middle" dominant-baseline="central">data/tools-data.json</text>
  <text class="ts" x="340" y="344" text-anchor="middle" dominant-baseline="central">3,500+ tools · master dataset</text>
</g>

<!-- Arrow to Convex -->
<line x1="340" y1="354" x2="340" y2="390" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>

<g class="node c-teal" onclick="sendPrompt('What does Convex do in Pookies AI Zone?')">
  <rect x="200" y="390" width="280" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="340" y="410" text-anchor="middle" dominant-baseline="central">Convex (cloud backend)</text>
  <text class="ts" x="340" y="428" text-anchor="middle" dominant-baseline="central">Real-time sync · full-text search · schema</text>
</g>

<!-- Arrow down to Backend -->
<line x1="340" y1="446" x2="340" y2="482" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>

<!-- ====== Backend ====== -->
<text class="ts" x="40" y="500" style="font-weight:500;fill:var(--color-text-secondary)">Backend</text>

<g class="node c-purple" onclick="sendPrompt('What does backend/server.py do in Pookies?')">
  <rect x="200" y="512" width="280" height="44" rx="8" stroke-width="0.5"/>
  <text class="th" x="340" y="530" text-anchor="middle" dominant-baseline="central">FastAPI (backend/server.py)</text>
  <text class="ts" x="340" y="546" text-anchor="middle" dominant-baseline="central">REST API · request handling</text>
</g>

<!-- Arrow to Frontend -->
<line x1="340" y1="556" x2="340" y2="592" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>

<!-- ====== Frontend ====== -->
<text class="ts" x="40" y="612" style="font-weight:500;fill:var(--color-text-secondary)">Frontend (Expo + React Native + TypeScript)</text>

<!-- Big frontend container -->
<rect x="40" y="624" width="600" height="160" rx="12" fill="none" stroke="var(--color-border-secondary)" stroke-width="1" stroke-dasharray="6 4"/>

<!-- app/ -->
<g class="node c-blue" onclick="sendPrompt('What screens are in the Pookies frontend app/ folder?')">
  <rect x="60" y="644" width="130" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="125" y="666" text-anchor="middle" dominant-baseline="central">app/</text>
  <text class="ts" x="125" y="682" text-anchor="middle" dominant-baseline="central">Home, Compare,</text>
  <text class="ts" x="125" y="694" text-anchor="middle" dominant-baseline="central">Favorites, Detail</text>
</g>
<!-- components/ -->
<g class="node c-blue" onclick="sendPrompt('What are the reusable components in Pookies?')">
  <rect x="204" y="644" width="130" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="269" y="666" text-anchor="middle" dominant-baseline="central">components/</text>
  <text class="ts" x="269" y="682" text-anchor="middle" dominant-baseline="central">Reusable UI</text>
  <text class="ts" x="269" y="694" text-anchor="middle" dominant-baseline="central">Search, Cards</text>
</g>
<!-- theme/ -->
<g class="node c-blue" onclick="sendPrompt('How is the Pookies design system organized?')">
  <rect x="348" y="644" width="130" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="413" y="666" text-anchor="middle" dominant-baseline="central">theme/</text>
  <text class="ts" x="413" y="682" text-anchor="middle" dominant-baseline="central">Colors, fonts,</text>
  <text class="ts" x="413" y="694" text-anchor="middle" dominant-baseline="central">spacing tokens</text>
</g>
<!-- services/ + android/ -->
<g class="node c-blue" onclick="sendPrompt('What do the services and android folders contain in Pookies?')">
  <rect x="492" y="644" width="130" height="56" rx="8" stroke-width="0.5"/>
  <text class="th" x="557" y="666" text-anchor="middle" dominant-baseline="central">services/ + android/</text>
  <text class="ts" x="557" y="682" text-anchor="middle" dominant-baseline="central">API calls +</text>
  <text class="ts" x="557" y="694" text-anchor="middle" dominant-baseline="central">APK build output</text>
</g>

<!-- convex/ label inside container -->
<text class="ts" x="350" y="758" text-anchor="middle" style="fill:var(--color-text-tertiary)">convex/ · backend config + real-time schema</text>

<!-- Arrow to User -->
<line x1="340" y1="784" x2="340" y2="806" class="arr" marker-end="url(#arrow)" stroke="var(--color-border-secondary)"/>

<!-- User -->
<text class="ts" x="340" y="816" text-anchor="middle" style="font-weight:500;fill:var(--color-text-secondary)">User (Android app · iOS coming soon)</text>

</svg>
loading pookies_ai_zone_architecture.svg…]()
